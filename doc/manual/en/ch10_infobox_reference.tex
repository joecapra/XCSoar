...
relative to the safety arrival height, and the geometric glide ratio required to
reach the home waypoint. Tap to select or change the home waypoint.}
...
\ibi{Contest distance}{Cont Dist}{Instantaneous evaluation of the flown
...
up the airfields or waypoint details.}
